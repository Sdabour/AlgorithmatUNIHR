...
namespace SharpVision.GL.GLDataBase
{
    public class CheckDb
    {
       ...
       // int _ReservationID;
        ...
        static string _CheckIDTable;

        public static string CheckIDTable
        {
            get { return CheckDb._CheckIDTable; }
            set { CheckDb._CheckIDTable = value; }
        }
        int _ReservationID;
        ...
        public static DataTable CachePaymentTable
        {
            get
            {
                if (_CachePaymentTable == null && ((_CheckIDs != null && _CheckIDs != "")||(_CheckIDTable!= null && _CheckIDTable != "")))
                {
                    ...
                    else 
                    {
                        ...
                        objDb.CheckIDTable = _CheckIDTable;
        ...
        public  string SearchStr
        {
            get
            {
                ...
                if (_ReservationID != 0)
                {
                    string strReservationCustomer = "SELECT         CustomerID "+
                          " FROM            dbo.CRMReservationCustomer where ReservationID = "+_ReservationID;
        ...
        public string StrSearch
        {
            get
            {
                ...
                if (_HasPaymentStatus == 2)
                    Returned += " and CheckPaymentTable.CheckID is null ";
       ...
       if(objDR.Table.Columns["CheckIsBankOriented"]!= null )
        ...
        public virtual DataTable Search()
        {
            ...
            strSql = "select  top 5000 * from (" + strSql + ") as NativeTable order by CheckID ";
            _CheckIDTable = "select CheckID from (" + strSql + ") as Checktable1";
