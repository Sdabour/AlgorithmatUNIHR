...
namespace Algorithmat.Algorithmat.AlgorithmatDataBase
{
    public class FileDb
    {
        ...
        void AddEditOnWeb()
        {
            ...
            _ID= objService.AddEditFile(dsTemp);
        }
        void DeleteOnWeb()
        {
            AlgorithmatOnlineService objService = new AlgorithmatOnlineService();
        ...
        DataTable SearchOnWeb()
        {
            ...
            AlgorithmatOnlineService objService = new AlgorithmatOnlineService();
            objService.Url = SysData.ServiceUrl;
            DataSet dsTemp = objService.SearchFile(_ID, _IDs, _TitleA, _Desc, _CountryID, _SubjectID,
                _IsDateRange, _StartDate, _EndDate, _Type);
