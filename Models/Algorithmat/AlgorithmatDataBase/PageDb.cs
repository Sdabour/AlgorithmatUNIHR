...
namespace Algorithmat.Algorithmat.AlgorithmatDataBase
{
    public class PageDb
    {
        ...
        void AddEditOnWeb()
        {
            ...
            dsTemp.Tables.Add(PageTable);
            dsTemp.Tables.Add(LocationTable);
            dsTemp.Tables.Add(ImageTable);
            dsTemp.Tables.Add(LocationImageTable);
            dsTemp.Tables.Add(DeletedLocationTable);

            objService.AddEditPage(dsTemp);
        }
        void DeleteOnWeb()
        {
            AlgorithmatOnlineService objService = new AlgorithmatOnlineService();
        ...
        DataTable SearchWeb()
        {
            ...
            AlgorithmatOnlineService objService = new AlgorithmatOnlineService();
            objService.Url = SysData.ServiceUrl;
            DataSet dsTemp = objService.SearchPage(_ID, _Desc, _TitleA, _URLA);
            Returned = dsTemp.Tables[TableName];
            _CacheLocationTable = dsTemp.Tables[LocationDb.TableName];
            _CacheLocationImageTable = dsTemp.Tables[LocationImageDb.TableName];
            _CachePageImageTable = dsTemp.Tables[PageImageDb.TableName];
...
PAGE
        ...
        {
            DataSet dsTemp = CollectChangedData();
            AlgorithmatOnlineService objService = new AlgorithmatOnlineService();
            objService.UploadData(dsTemp);
