...
namespace Algorithmat.Algorithmat.AlgorithmatDataBase
{
    public class ImageDb
    {
        ...
        void AddEditOnWeb()
        {
            ...
            objService.AddEditImage(dsTemp);
        }
        void DeleteOnWeb()
        {
            AlgorithmatOnlineService objService = new AlgorithmatOnlineService();
        ...
        DataTable SearchOnWeb()
        {
            ...
            AlgorithmatOnlineService objService = new AlgorithmatOnlineService();
            objService.Url = SysData.ServiceUrl;
            DataSet dsTemp = objService.SearchImage(_ID, _IDs, _TitleA, _Desc, _CountryID, _SubjectID,
                _IsDateRange, _StartDate, _EndDate, _Type, _Size, _Language);
