...
namespace SharpVision.UMS.UMSDataBase
{
    public class FunctionDb:BaseSelfRelatedDb 
    {
        ...
        public static string SearchStr
        {
            get
            {
                string Returned = "SELECT FunctionID, FunctionNameA,FunctionNameE, FunctionDescription, FunctionParentID, FunctionFamilyID,FunctionIsStoped,FunctionUrl,SysID,Dis FROM  UMSFunction ";
                return Returned;
        ...
        void SetData(DataRow DR)
        {
            ...
            _ParentID = int.Parse(DR["FunctionParentID"].ToString());
             int.TryParse(DR["FunctionFamilyID"].ToString(),out _FamilyID);
        ...
        public override DataTable Search()
        {
            ...
            if (BaseDb.SysID != 0)
            {
                ...
                strSql = strSql + " and SysID = " + intSysID;
            }
            if (_ID != 0)
