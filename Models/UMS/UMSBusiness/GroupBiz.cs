...
namespace SharpVision.UMS.UMSBusiness
{
    ...
    public class GroupBiz:BaseSelfeRelatedBiz
    {
       ...
       // GroupBiz _ParentBiz;
        ...
        public UserFunctionInstantCol GetUserFunctionInstantCol(int intSystem)
        {
            UserFunctionInstantCol Returned = new UserFunctionInstantCol(true);
            GroupFunctionInstantDb objDb = new GroupFunctionInstantDb() { GroupID = ID, SysID = intSystem, OnlyNonStopedFunction = true };
