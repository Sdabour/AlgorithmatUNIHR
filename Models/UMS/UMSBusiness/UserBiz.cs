...
namespace SharpVision.UMS.UMSBusiness
{
    public class UserSmple1
    {
        ...
        { set; get; }
        List<FunctionSimple> _FunctionLst;
        ...
        public List<SectorSimple> AssignedSector { set; get; } = new List<SectorSimple>();
        public List<AssignedObjectID> AssignedIDs { set; get; } = new List<AssignedObjectID>();
    }
    public class AssignedObjectID
    {
        public string ObjectCode { set; get; }
        public List<int> AssignedIDs { set; get; } = new List<int>();
    }
    ...
    public class UserBiz
    {
       ...
       [DataType(DataType.Password)]
        ...
        public UserSmple1 TempUserSimple
        {
            get
            {
                UserSmple1 Returned = new UserSmple1() { ID = ID, Name = Name, EmployeeID = EmployeeBiz.ID, EmployeeCode = EmployeeBiz.Code, EmployeeName = EmployeeBiz.Name, Job = "", Sector = EmployeeBiz.DepartmentStr, WorkGroup = EmployeeBiz.WorkGroupBiz.ID, WorkGroupName = EmployeeBiz.WorkGroupBiz.Name };
                Returned.FunctionLst = new List<FunctionSimple>();
                foreach (UserFunctionInstantBiz objBiz in UserFunctionInstantCol)
                    Returned.FunctionLst.Add(new FunctionSimple() { ID = objBiz.ID, Name = objBiz.Name });
        ...
        public static UserBiz CurrentUser
        {
            ...
            get
            {
                ...
                if (System.Web.HttpContext.Current != null && System.Web.HttpContext.Current.Session != null && System.Web.HttpContext.Current.Session["CurrentUser"] != null)
                {
