...
namespace SharpVision.SystemBase
{
    ...
    public static class SysUtility
    {
        ...
        public static string GenerateBarcode(string strQRData)
        {
            ...
            Bitmap result = new Bitmap(qr.Write(strQRData));
            MemoryStream objStream =new MemoryStream();
            result.Save(objStream, System.Drawing.Imaging.ImageFormat.Png);
            byte[] byteData =objStream.ToArray();
        ...
        public static string GetStr(this List<int> arrIDs)
        {
            string Returned = "";
            foreach(int intID in arrIDs)
            {
                if (Returned != "")
                    Returned += ",";
        ...
        //public static List<string> GetLst(this List<s> lstStr,)
