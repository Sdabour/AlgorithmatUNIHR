...
namespace SharpVision.SystemBase
{
    ...
    public static class SysData
    {
        ...
        private static BaseDb _MilangoServiceDb;
        ...
        static UserBiz _DesktopUserBiz;
        public static UserBiz DesktopUserBiz { set => _DesktopUserBiz = value; get=>_DesktopUserBiz; }
        public static UserBiz CurrentUser
        {
            //set
            //{
            //    UserBiz.CurrentUser = value;
            //    //_CurrentUser = value;
            //}
            get
            {
               // _CurrentUser = null;
                ...
                if (_DesktopUserBiz == null&& System.Web.HttpContext.Current != null && System.Web.HttpContext.Current.Session != null && System.Web.HttpContext.Current.Session["CurrentUser"] != null)
                {
                    objUserBiz = (UserBiz)System.Web.HttpContext.Current.Session["CurrentUser"];
                }
                if (_DesktopUserBiz != null && objUserBiz.ID == 0)
                    objUserBiz = _DesktopUserBiz;
        ...
        public static UMSBranchBiz CurrentBranch
        {
            ...
            get
            {
                ...
                if (System.Web.HttpContext.Current.Session != null && System.Web.HttpContext.Current.Session["Branch"] != null)
                {
                    objBranchBiz = (UMSBranchBiz)System.Web.HttpContext.Current.Session["Branch"];
                }
        ...
        public static int SysID
        {
            ...
            get
            {
                if (System.Web.HttpContext.Current != null&& System.Web.HttpContext.Current.Session != null && System.Web.HttpContext.Current.Session["SysID"] != null)
                {
                    int.TryParse(System.Web.HttpContext.Current.Session["SysID"].ToString(), out _SysID);


                }
                else if(_SysID==0)
                {
                    string strTemp = System.Configuration.ConfigurationManager.AppSettings["SysID"];
                    if (strTemp == null)
                        strTemp = "";
                    int.TryParse(strTemp, out _SysID);
                    if(System.Web.HttpContext.Current.Session!= null)
                    System.Web.HttpContext.Current.Session["SysID"] = _SysID;
                }
                return _SysID;
            }
        }
        static int GetFacultyIDFromWebConfig()
        {
            int Returned = 1;
            if (System.Web.HttpContext.Current != null && System.Web.HttpContext.Current.Session != null && System.Web.HttpContext.Current.Session["FacultyID"] != null)
            {
                int.TryParse(System.Web.HttpContext.Current.Session["FacultyID"].ToString(), out Returned);


            }
            return Returned;
        }
        static int _FacultyID = 0;
        public static int FacultyID
        {
            ...
            get
            {
                if (_FacultyID == 0)
                {
                    return GetFacultyIDFromWebConfig();
                }
                else
                    return _FacultyID;
            }
        }
        static string _FacultyName;
        ...
        public static BaseDb MilngoServiceBaseDb
        {
            set
            {
                _SharpVisionBaseDb = value;
