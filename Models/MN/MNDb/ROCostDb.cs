...
namespace AlgorithmatMN.MN.MNDb
{
    public class ROCostDb
    {
        ...
        int _ProjectPartStatus;
        public int ProjectPartStatus { set => _ProjectPartStatus = value; }
        DateTime _StartDate;
        ...
        { set => _YearsStr = value; }
        string _ProjectCostIDs;
        public string ProjectCostIDs { set => _ProjectCostIDs = value; }
  ...
  from MNROCost  
   ...
   on MNROCost.CostRO = ROTable.ROID ";
        ...
        public DataTable Search()
        {
            ...
            if (_ProjectCostIDs != null && _ProjectCostIDs != "")
                strSql += " and CostProjectCost in ("+_ProjectCostIDs+")";
            if (_ProjectPartStatus == 1)
                strSql += " and  CostProjectCost >0 ";
            else
                strSql += " and isnull(CostProjectCost,0)=0  ";
