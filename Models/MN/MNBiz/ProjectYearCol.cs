...
namespace AlgorithmatMN.MN.MNBiz
{
    public class ProjectYearCol : CollectionBase
    {
        ...
        public ProjectYearCol(int intLastYear, string strProject)
        {
            ...
            YearBiz objYearBiz = new YearBiz();
            if (YearCol.CacheYearHs[intLastYear.ToString()] != null)
                objYearBiz = (YearBiz)YearCol.CacheYearHs[intLastYear.ToString()];
            DateTime dtEnd = objYearBiz.EndDate;
            lstProjectCodes.Add(strProject);
            ROCol objRoCol = new ROCol(lstProjectCodes);
            ProjectYearCol objCol = objRoCol.GetProjectYearCol(dtEnd);
            foreach (ProjectYearBiz objProjectYearBiz in objCol)
                Add(objProjectYearBiz);
        ...
        public ProjectYearBiz GetProjectYearBiz(string strPrtojectCode,DateTime dtDate)
        {
            ProjectYearBiz Returned = new ProjectYearBiz();
            //List<ProjectYearBiz> 
            return Returned;
        }
