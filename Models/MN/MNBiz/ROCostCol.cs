...
namespace AlgorithmatMN.MN.MNBiz
{
    public class ROCostCol : CollectionBase
    {
        ...
        public ROCostCol(string strProjectCode,int intRO, CostTypeBiz objCostType, bool blIsDate, DateTime dtSTartDate, DateTime dtEndDate,int intProjectPartStatus)
        {
            ...
            objDb.ProjectPartStatus = intProjectPartStatus;
       ...
       public ROCol ROCol
        { get 
            {
                ...
                foreach(ROCostBiz objCostBiz in this)
                {
                    Returned.Add(objCostBiz.ROBiz);
                }
        ...
        public void IntializeValue()
        {
            ...
            {
                if (objCost.Year == 0)
                    objCost.YearBiz = YearCol.CacheYearCol.GetYearBiz(objCost.Date);
            }
        }
