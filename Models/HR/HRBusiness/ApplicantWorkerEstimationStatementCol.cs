...
namespace SharpVision.HR.HRBusiness
{
    public class ApplicantWorkerEstimationStatementCol : CollectionBase
    {
        ...
        public ApplicantWorkerEstimationStatementCol(EstimationStatementBiz objEstimationStatementBiz, ApplicantWorkerCol objApplicantWorkerCol)
        {
            ...
            EstimationAssignmentCol objAssignmentCol;
            ...
            foreach (ApplicantWorkerBiz objWorkerBiz in objApplicantWorkerCol)
            {
                ...
                else
                {
                    ...
                    objAssignmentCol = EstimationAssignmentCol.ChacheAssignment.GetCol(objWorkerBiz);
                    if (objAssignmentCol.Count > 0)
                    {
                        objAssignmentBiz = objAssignmentCol[0];
                        objAssignmentBiz.AdjustElementGroup();

                        objBiz.EstimationStatementElementCol.Add(objAssignmentBiz.ElementCol.ApplicantWorkerEstimationStatmentElementCol);
                    }
                    #region OldCode
