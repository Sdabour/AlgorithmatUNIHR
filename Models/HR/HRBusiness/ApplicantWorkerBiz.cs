...
namespace SharpVision.HR.HRBusiness
{
    ...
    public class ApplicantWorkerBiz : ApplicantBiz
    {
        ...
        ApplicantWorkerMotivationCostCenterCol _MotivationCostCenterCol;
        public ApplicantWorkerMotivationCostCenterCol MotivationCostCenterCol
        {
            set
            {
                _MotivationCostCenterCol = value;
            }
            get
            {
                if (_MotivationCostCenterCol == null)
                {
                    _MotivationCostCenterCol = new ApplicantWorkerMotivationCostCenterCol(true);
                    if (ID != 0)
                    {
                        ...
                        {
                            _MotivationCostCenterCol.Add(new ApplicantWorkerMotivationCostCenterBiz(objDr, this));
                        }

                    }
                }
                return _MotivationCostCenterCol;
            }
        }
        ApplicantWorkerMotivationCostCenterBiz _MotivationCostCenterBiz;
        public ApplicantWorkerMotivationCostCenterBiz MotivationCostCenterBiz
        {
            set
            {
            ...
            get
            {
                if (_MotivationCostCenterBiz == null)
                {
                    _MotivationCostCenterBiz = new ApplicantWorkerMotivationCostCenterBiz();
                    foreach (ApplicantWorkerMotivationCostCenterBiz objBiz in MotivationCostCenterCol)
                    {
                        _MotivationCostCenterBiz = objBiz;
                        break;
                    }
                }
        ...
        public string QRStr
        {
            get
            {
                string Returned = Code + "-"+Name + "-"+SubSectorAndJobStr + "-"+StartDate.ToString("yyyy-MM-dd");
                return Returned;
            }
        }
