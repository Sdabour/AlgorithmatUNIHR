...
namespace SharpVision.HR.HRBusiness
{
    public class CostCenterHRCol : BaseCol
    {
        ...
        public  CostCenterHRCol GetCostCenterHRTreeCol(MotivationStatementBiz objMotivationStatementBiz)
        {
            CostCenterHRCol objCostCenterHRCol = new CostCenterHRCol(true); ;
            ...
            //objDb.CostCenterParent = 16;
            DataTable dtCostcenterTree = objDb.Search();

            //DataTable dtCostCenterParent;

            DataRow[] arrCostCenterParentDR = dtCostcenterTree.Select("CostCenter=CostCenterParent ");
            CostCenterHRBiz objCostCenterHRBiz;
            CostCenterHRBiz objTempParent = new CostCenterHRBiz();

            foreach (DataRow DR in arrCostCenterParentDR)
            {
                objCostCenterHRBiz = new CostCenterHRBiz(int.Parse(DR["CostCenter"].ToString()));
                SetChildren(ref objCostCenterHRBiz, ref dtCostcenterTree);

                objCostCenterHRBiz.CostCenterParentBiz = objCostCenterHRBiz;
                objCostCenterHRCol.Add(objCostCenterHRBiz);
            }
            return objCostCenterHRCol;
        }
        public CostCenterHRCol GetCostCenterHRTreeCol(MotivationStatementBiz objMotivationStatementBiz, CostCenterTypeBiz objCostCenterTypeBiz)
        {
            CostCenterHRCol objCostCenterHRCol = new CostCenterHRCol(true); ;
            MotivationStatementCostcenterTreeDb objDb = new MotivationStatementCostcenterTreeDb();
            objDb.MotivationStatement = objMotivationStatementBiz.ID;
