...
namespace SharpVision.HR.HRBusiness
{
    public class ApplicantWorkerEstimationStatementBiz
    {
        ...
        public ApplicantWorkerEstimationStatementElementCol EstimationStatementElementCol
        {
            set
            {
            ...
            get
            {
                if (_EstimationStatementElementCol == null)
                {
                    ...
                    if (ID == 0 && _ApplicantWorkerBiz.ID != 0)
                    {
                        EstimationAssignmentBiz objAssignmentBiz;
                        EstimationAssignmentCol objAssignmentCol = EstimationAssignmentCol.ChacheAssignment.GetCol(_ApplicantWorkerBiz);
                        if (objAssignmentCol.Count > 0)
                        {
                            objAssignmentBiz = objAssignmentCol[0];
                            objAssignmentBiz.AdjustElementGroup();
                            _EstimationStatementElementCol.Add(objAssignmentBiz.ElementCol.ApplicantWorkerEstimationStatmentElementCol);
                        }
                    }
                    #region Old
        ...
        void SaveEstimationElement()
        {
            RemoveEstimationElement();
            foreach (ApplicantWorkerEstimationStatementElementBiz objBiz in EstimationStatementElementCol)
            {
                objBiz.ID = this.ID;
                objBiz.ElementValue = objBiz.ElementBiz.ElementValue;
                int x = objBiz.ElementBiz.ID;
                objBiz.Add();
            }
        }
