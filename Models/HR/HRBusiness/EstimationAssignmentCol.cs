...
namespace SharpVision.HR.HRBusiness
{
    public class EstimationAssignmentCol : CollectionBase
    {
        ...
        static EstimationAssignmentCol _CacheAssignment;
        public static EstimationAssignmentCol ChacheAssignment {
            set => _CacheAssignment = value;
            get {
                EstimationAssignmentCol objCol =new EstimationAssignmentCol(true);

                if (System.Web.HttpContext.Current.Session != null && System.Web.HttpContext.Current.Session["CacheAssignment"] != null)
                {
                    objCol = (EstimationAssignmentCol)System.Web.HttpContext.Current.Session["CacheAssignment"];
                }
                else
                {
                    objCol = new EstimationAssignmentCol(false);
                    System.Web.HttpContext.Current.Session["CacheAssignment"] = objCol;
                }

            //        if (_CacheAssignment == null)
            //{

            //        _CacheAssignment = new EstimationAssignmentCol(false);
            //        _CacheAssignment.SetData();
