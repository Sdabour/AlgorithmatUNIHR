...
GROUP BY ApplicantEstimationStatement ";
                string Returned = " SELECT    HRApplicantWorkerEstimationStatement.ApplicantEstimationStatementID, " +
                                  ...
                                  " inner join (" + new ApplicantWorkerDb() { }.ShortSearchStr + ") as ApplicantWorkerTable On ApplicantWorkerTable.ApplicantID = HRApplicantWorkerEstimationStatement.Applicant" +
        ...
        void SetData(DataRow objDr)
        {
            ...
            double.TryParse(objDr["EstimationValue"].ToString(),out _EstimationValue);
