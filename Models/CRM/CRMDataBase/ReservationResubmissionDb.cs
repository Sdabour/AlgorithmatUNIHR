    ...
    public class ReservationResubmissionDb
    {
        ...
        public static string SearchStr
        {
            get
            {
                ...
                string Returned = "SELECT        ResubmissionID, ResubmissionReservation, ResubmissionType, ResubmissionDesc, ResubmissionDate, ResubmissionEndDate, UsrIns as ResubmissionUsrIns, TimIns as ResubmissionTimIns "+
                    ",ResubmissionTypeTable.*,UserTable.*,LegalTable.* " +
        ...
        public string StrSearch
        {
            get {
                ...
                if (_ResubmissionType != 0)
                    Returned += " and ResubmissionType="+_ResubmissionType ;
                if(_ResubmissionTypeIDs!= null && _ResubmissionTypeIDs!= "")
                    Returned += " and ResubmissionType in (" + _ResubmissionTypeIDs + ")";
