...
namespace SharpVision.CRM.CRMDataBase
{
    public class WorkerContributionDb
    {
        ...
        public WorkerContributionDb(DataRow objDR)
        {
            ...
            _PaidValue = double.Parse(objDR["PaidValue"].ToString());
            _ContributionPerc = double.Parse(objDR["ContributionPerc"].ToString());
            _ContributionValue = double.Parse(objDR["ContributionValue"].ToString());
            _Finished = bool.Parse(objDR["Finished"].ToString());
        ...
        public static string SearchStr
        {
            get
            {
                string Returned = "SELECT     ReservationID, ContributionPerc, ContributionValue, PaidValue, Finished,WorkerTable.* "+
