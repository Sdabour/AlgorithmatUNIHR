...
namespace SharpVision.CRM.CRMBusiness
{
    public class UnitCol : BaseCol
    {
        ...
        #region Private Data
        Hashtable _UnitHash = new Hashtable();
        int _MaxCount = 1500;
        int _ResultCount = 0;
        int _TheMinID;
        int _MaxID;
        ...
        {
            if (_UnitHash[objBiz.ID.ToString()] == null)
            {
                _UnitHash.Add(objBiz.ID.ToString(), objBiz);
        ...
        public DataTable GetTable()
        {
            ...
            new DataColumn("UnitUserClosed"),new DataColumn("UnitView"),new DataColumn("UnitMainType"),
