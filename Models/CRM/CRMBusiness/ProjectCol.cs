...
namespace SharpVision.CRM.CRMBusiness
{
    public class ProjectCol : BaseCol
    {
        ...
        Hashtable _ProjectHs = new Hashtable();
        ...
        public ProjectBiz this[string strCode]
        {
            get
            {
                ProjectBiz Returned = new ProjectBiz();
                if (_ProjectHs[strCode] != null)
                    Returned = this[(int)_ProjectHs[strCode]];
                return Returned;
            }
        }
        ...
        {
            if (_ProjectHs[objProjectBiz.Code] == null)
                _ProjectHs.Add(objProjectBiz.Code, Count);
