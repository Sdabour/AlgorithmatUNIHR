        ...
        #region Public Methods
          ...
          public DataTable GetCheckTable()
          {
              ...
              Returned.Columns.AddRange(new DataColumn[] {new DataColumn("رقم"), new DataColumn("كود الشيك"),new DataColumn("المحرر"),new DataColumn("المستفيد"),
                ...
                new DataColumn("مكان الشيك"),new DataColumn("المشروع"),new DataColumn("البرج"),new DataColumn("الوحدة"),
                     ...
                     if (!blIsNewRow)
                      ...
                      //{
                         // objDr[8] = objPaymentBiz.PaymentDesc;
                          ...
                          objDr[14] = objPaymentBiz.UnitStr;
                          objDr[15] = objPaymentBiz.CustomerStr;
                          objDr[16] = objPaymentBiz.UnitIsDelivered ? "تم التسليم" : "لم يتم التسليم";
                      //}
