...
{
    public partial class ALGORITHMATMaster : System.Web.UI.MasterPage
    {
        ...
        public void SetHeaderLink()
        {
            ...
            string strMainUrl = "";
            if(System.Configuration.ConfigurationManager.AppSettings["MainURL"]!= null)
            strMainUrl = System.Configuration.ConfigurationManager.AppSettings["MainURL"];
            if (strMainUrl != "")
                strMainUrl += "/";
            a1.Attributes["href"] = strMainUrl + a1.Attributes["href"];
            string strTemp = a1.Attributes["href"];
            a2.Attributes["href"] = strMainUrl + a2.Attributes["href"];
            a3.Attributes["href"] = strMainUrl + a3.Attributes["href"];
            a4.Attributes["href"] = strMainUrl + a4.Attributes["href"];
            a5.Attributes["href"] = strMainUrl + a5.Attributes["href"];
