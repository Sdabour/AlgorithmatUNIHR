...
btnAddTempPayment*/
    ...
    FillSelectedTable() {
        ...
        let objStudent: Student = new Student();
        let dblRemaining: Number = 0; //objStudent.GetRemainingValue();
